...
<body>
  <div className="relative h-64 bg-gradient-to-r from-slate-500 to-slate-200">
    <div className="absolute inset-0 flex items-center justify-center text-white">
      <div className= "bg-transparent p-8 rounded-2xl border-2 border-white shadow-lg">
        <h1 className="text-white text-4xl font-bold relative z-0 flex">William O&aposHalloran</h1>
